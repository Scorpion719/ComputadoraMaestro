...
namespace Computadoras.Models
{
    public partial class ComputadorasContext : DbContext
    {
        public ComputadorasContext()
        {
        }

        public ComputadorasContext(DbContextOptions<ComputadorasContext> options)
            : base(options)
        {
        }
