...
using Computadoras.Models;

namespace Computadoras.Controllers
{
    public class ComputadorasController : Controller
    {
        private readonly ComputadorasContext _context;

        public ComputadorasController(ComputadorasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Computadoras != null ? 
                          ...
                          Problem("Entity set 'ComputadorasContext.Computadoras'  is null.");
        }
        ...
        {
            //computadora.Componente = computadora.Componente.Sum(s => s.Precio * s.PrecioUnitario);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ComputadorasContext.Computadoras'  is null.");
            }
